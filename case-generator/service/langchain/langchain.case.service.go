...
func NewLangchainCaseService() *LangchainCaseService {
	return &LangchainCaseService{
		llmService: service.GetLLMService(),
	}
}

func (s *LangchainCaseService) GenerateWholeCase(ctx context.Context, diseaseName string, bitMask byte, symptoms []models.Symptom, patientPresentation models.PatientPresentation, anamnesis []models.Anamnesis, procedures []models.Procedure) (models.PatientPresentation, []models.Anamnesis, error) {
...
func NewGetCurrentStateTool(ctx *service.CaseContext) *GetCurrentStateTool {
