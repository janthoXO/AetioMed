...
export async function generateProceduresFromOutline(
  ...
  outline?: string, // generated by a previous chain step
  ...
  const systemPrompt = buildPrompt(
    `You are an expert attending physician designing the diagnostic workup for a medical training simulator. Your current task is to order the required Procedures ${outline ? "based on the provided Case Outline" : ""}.`,
...
Original Procedures:
${JSON.stringify({ procedures: requiredFixes.case.procedures })}
