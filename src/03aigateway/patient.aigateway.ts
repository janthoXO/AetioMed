...
export async function generatePatientFromOutline(
  ...
  const systemPrompt = buildPrompt(
    `You are an expert medical educator authoring a realistic clinical patient file for a medical training simulator. Your current task is to generate the Patient Demographics ${outline ? "based on the provided Case Outline." : ""}`,
...
Original Patient:
${JSON.stringify({ patient: requiredFixes.case.patient })}
