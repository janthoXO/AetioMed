...
export async function generateAnamnesisFromOutline(
  ...
  const systemPrompt = buildPrompt(
    `You are an AI generating data for a medical training simulator. Your current task is to generate the Anamnesis (medical history) ${outline ? "based on the provided Case Outline" : ""}.`,
...
Original Anamnesis:
${JSON.stringify({ anamnesis: requiredFixes.case.anamnesis })}
