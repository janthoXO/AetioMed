...
export async function generateChiefComplaintFromOutline(
  ...
  const systemPrompt = buildPrompt(
    `You are an expert attending physician documenting a patient's presentation for a medical training simulator. Your current task is to generate the Chief Complaint based on the provided Case Outline.`,
    fixingMode
...
${JSON.stringify({ chiefComplaint: previousCase.chiefComplaint })}
