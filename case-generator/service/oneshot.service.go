...
func (s *OneshotService) createOneShotPrompt(diseaseName string, fieldsToGenerate byte, symptoms []models.Symptom, patientPresentation models.PatientPresentation, anamnesis []models.Anamnesis, procedures []models.Procedure) string {
...
- Answer in German`,
		...
		func() string {
			var fields []string
			if models.PatientPresentationFlag.IsInBitMask(fieldsToGenerate) {
				fields = append(fields, fmt.Sprintf(`"patientPresentation": %s`, models.PatientPresentationExampleJSON))
			}
...
func (s *OneshotService) GenerateOneShotCase(ctx context.Context, diseaseName string, fieldsToGenerate byte, symptoms []models.Symptom, patientPresentation models.PatientPresentation, anamnesis []models.Anamnesis, procedures []models.Procedure) (models.PatientPresentation, []models.Anamnesis, error) {
